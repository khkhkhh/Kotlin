...
class Parrot9(name: String, wing: Int=2, beak: String, color: String,
             var language: String="natural") : Bird9(name, wing, beak, color){
...
fun main(){
    val parrot=Parrot9(name="myparrot", beak="short", color="multiple")
